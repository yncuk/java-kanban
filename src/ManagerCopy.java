...
public class ManagerCopy {
    ...
    public Task createTask(Task task) {
        ...
        task.setName("Купить сахар");
        task.setDescription(id + " кг");
        task.setId(id);
        id++;
        while (true) {
    ...
    public Subtask createSubtask(Subtask subtask) {
        ...
        subtask.setName("купить воду");
        subtask.setDescription(id + " л");
        subtask.setId(id);
        id++;
        while (true) {
    ...
    public Epic createEpic(Epic epic) {
        ...
        epic.setName("Поход в магазин");
        epic.setDescription("в макси");
        epic.setId(id);
        id++;
        changeStatusEpic(epic);
